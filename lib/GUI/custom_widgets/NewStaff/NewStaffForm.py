...
class NewStaffForm(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(content_F, text="Name*: ", font=font).grid(row=0, column=0, padx=5, pady=5, sticky=tk.W)
        self.name_E = ttk.Entry(content_F, font=font, width=25)
        self.name_E.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Vorname*: ", font=font).grid(row=1, column=0, padx=5, pady=5, sticky=tk.W)
        self.forename_E = ttk.Entry(content_F, font=font, width=25)
        self.forename_E.grid(row=1, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Abteilung*: ", font=font).grid(row=2, column=0, padx=5, pady=5, sticky=tk.W)
        self.dep_E = ttk.Entry(content_F, font=font, width=25)
        self.dep_E.grid(row=2, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Email*: ", font=font).grid(row=3, column=0, padx=5, pady=5, sticky=tk.W)
        self.email_E = ttk.Entry(content_F, font=font, width=25)
        self.email_E.grid(row=3, column=1, padx=5, pady=5, sticky=tk.W)
    ...
    def add_new_staff(self):
        ...
        if not all([name, forename, dep, email]):
            ...
            ContactPersonManager.get_instance().add_new_contactPerson(
