...
class RobotOverviewToolbar(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        add_time_icon = tk.PhotoImage(file="res/img/add_time_icon.png")
        ...
        self.add_button = tk.Button(self, image=add_icon, relief=tk.FLAT, command=lambda: controller.show_frame("NewRobotPage"))
        self.add_button.photo = add_icon
        self.add_button.pack(side=tk.LEFT, padx=5, pady=5)

        self.add_time_button = tk.Button(self, image=add_time_icon, relief=tk.FLAT)
        self.add_time_button.photo = add_time_icon
        self.add_time_button.pack(side=tk.LEFT, padx=5, pady=5)
        ...
        ttk.Label(self, text="Robot Overview", font=("Arial", 15, "bold")).pack(side=tk.RIGHT, padx=10, pady=2)