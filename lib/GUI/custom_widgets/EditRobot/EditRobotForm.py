...
class EditRobotForm(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.id_E = tk.Entry(content_F, font=font, width=10)
        self.id_E.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="IPA*: ", font=font).grid(row=1, column=0, padx=5, pady=5, sticky=tk.W)
        self.ipa_E = tk.Entry(content_F, font=font, width=25)
        self.ipa_E.grid(row=1, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Name*: ", font=font).grid(row=2, column=0, padx=5, pady=5, sticky=tk.W)
        self.name_E = tk.Entry(content_F, font=font, width=25)
        self.name_E.grid(row=2, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Kurzbeschreibung: ", font=font).grid(row=3, column=0, padx=5, pady=5, sticky=tk.W)
        self.descr_E = tk.Entry(content_F, font=font, width=25)
        self.descr_E.grid(row=3, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(content_F, text="Kosten pro Stunde*: ", font=font).grid(row=4, column=0, padx=5, pady=5, sticky=tk.W)
        self.cost_E = tk.Entry(content_F, font=font, width=10)
        self.cost_E.grid(row=4, column=1, padx=5, pady=5, sticky=tk.W)
        ...
        ttk.Label(content_F, text="Laufzeit*: ", font=font).grid(row=5, column=0, padx=5, pady=5, sticky=tk.W)
        self.runtime_E = tk.Entry(content_F, font=font, width=10)
        self.runtime_E.grid(row=5, column=1, padx=5, pady=5, sticky=tk.W)
        ...
        ttk.Label(content_F, text="Kontaktperson: ", font=font).grid(row=6, column=0, padx=5, pady=5, sticky=tk.W)
        self.contact_CB = ttk.Combobox(content_F, font=font, state="readonly", width=49)
        self.contact_CB.grid(row=6, column=1, padx=5, pady=5, sticky=tk.W)
        ...
        ttk.Label(content_F, text="Kommentar: ", font=font).grid(row=7, column=0, padx=5, pady=5, sticky=tk.NW)
        self.comment_E = tk.Text(content_F, font=font, width=50, height=5)
        self.comment_E.grid(row=7, column=1, padx=5, pady=5, sticky=tk.W)
    ...
    def save_changes(self):
        ...
        if not all([ipa, name, cost, runtime]):
            ...
            RobotManager.get_instance().update_robot(
                id, ipa, name, sh_descr, cost, runtime, contact_person_id, comment
            )
